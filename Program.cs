...
namespace testWoW
{
    public class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            //IEquipment shoulders = new Neck();
            //IEquipment chest = new Neck();
            //IEquipment waist = new Neck();
            //IEquipment legs = new Neck();
            //IEquipment feet = new Neck();
            //IEquipment wrist = new Neck();
            //IEquipment gloves = new Neck();
            //IEquipment ring1 = new Neck();
            //IEquipment ring2 = new Neck();
            //IEquipment trinket1 = new Neck();
            //IEquipment trinket2 = new Neck();
            //IEquipment cloak = new Neck();
            //IEquipment mainhand = new Neck();
            //IEquipment offhand = new Neck();
            //IEquipment tabard = new Neck();
